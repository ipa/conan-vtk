...
int main(int, char *[]) {
    ...
    //vtkOpenGLRenderWindow rwin = vtkOpenGLRenderWindow::New();
    vtkRenderWindow *rwin = vtkRenderWindow::New();

    //rwin->SetFullScreen(true);
    rwin->SetSize(1920, 1080);
    //rwin->StereoCapableWindowOn();
    //rwin->SetStereoTypeToInterlaced();
    //rwin->StereoRenderOn();
    std::cout << rwin->GetStereoTypeAsString() << std::endl;
    ...
    renderWindowInteractor->SetRenderWindow(rwin);
